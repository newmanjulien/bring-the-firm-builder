...
export const BRING_THE_FIRM_BUILDER_DEFAULT_AI_CONTEXT = {
  personContext:
  ...
  emailFormatUse:
    "You are helping them build an email format for emails sent to people in their firm to support their Bring the Firm initiative. The goal is to bring together all their firm's disconnected data along with the sales data from their ecosystem partners and deliver actionable sales opportunities by email. Any and all data is available if the exec tells you it is. The absolute best analysis is available to back up this email format",
